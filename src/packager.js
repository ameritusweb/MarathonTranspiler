...
// Custom ignore list
const customIgnoreList = ['bootstrap.min.css', 'react-datepicker.min.css', 'Transpilers'];
...
async function getAllFiles(dirPath, arrayOfFiles = []) {
  try {
    ...
    for (const file of files) {
      ...
      } else if (/\.(js|jsx|ts|tsx|css|html|py|cs)$/i.test(file)) { // Case-insensitive matching
